...
public class PatientClass
{
    ...
    public PatientClass(int patientId, string name, string surname, string address, string phoneNumber, string email, string medicalRecord)
    {
    ...
    public void EditPatient(string name, string surname, string address, string phoneNumber, string email, string medicalRecord)
    {
        _name = name;
        _surname = surname;
        _address = address;
